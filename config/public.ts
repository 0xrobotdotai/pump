...
export const publicConfig = {
  ...
  ROBOT_PUMP_HASURA_URL: 'https://hasura-production-9feb.up.railway.app/v1/graphql',
  ROBOT_PUMP_HASURA_REST_URL: 'https://hasura-production-9feb.up.railway.app/api/rest',
}
